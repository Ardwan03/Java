...
class Temperatures2
{
    ...
    public static void main (String[] args)
    {
        ...
        for (int week = 1; week <= nofWeeks; week++)
        {
            minT[week] = min (t[week]);         //Ta hela lista 1... och spara den i metoden min()    // add code here
        ...
        public static double min (double[] temp)
        {
          ...
          for (int Measurements = 1; Measurements <= temp.length - 1; Measurements++){
            
            if (temp[Measurements] < Minsta){
                Minsta = temp[Measurements];
            }
          }         
        ...
        public static double max (double[] temp)
        {
          ...
          for (int Measurements = 1; Measurements <= temp.length - 1; Measurements++){
            ...
            if (temp[Measurements] > Största){
                Största = temp[Measurements];
            }
          }         
